...
label_ids = {'holothurian':1, 'echinus':2, 'starfish':3, 'scallop':4, 'waterweeds':5}
...
def save(images, annotations):
    ...
    json.dump(ann, open('testA.json', 'w'))
...
if __name__ == '__main__':
    test_dir = r'D:\2-deep_learning\0-data\undersea\test-A-image'
